...
import { additinoalservicesData } from "@/component/helper/Helper";
  ...
  return (
    <>
      <div className="max-w-[1440px] w-[100%] mx-auto">
        {additinoalservicesData.map((item, index) => (
          <div key={index} className="flex flex-wrap md:flex-nowrap">
            <div className="bg-[#fff] w-[100%] md:w-[43%] ps-[32px] sm:ps-[40px] md:ps-[50px] lg:ps-[70px] pe-[32px] md:pe-[60px] mt-[120] md:mt-[120px] pb-[60px]">
