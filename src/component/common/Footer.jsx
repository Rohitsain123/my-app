    ...
    <>
        <div className="bg-[#494336] pt-[60px] lg:pt-[80px] pb-[222px] sm:pb-[150px] lg:pb-[100px] xl:pb-[80px] relative">
            <div className="absolute end-0 bottom-0 max-w-[288px] md:max-w-[400px] lg:max-w-[584px]">
                <Image src={"/assetes/img/png/dog-cat.png"} width={584} height={400} alt={"dog"}/>
            </div>
            <div className="max-w-[1440px] mx-auto px-[32px] sm:px-[35px] md:px-[40px] lg:px-[180px] ">
                <h4 className="text-[24px] md:text-[30px] lg:text-[48px]  font-light text-[#D7D9DD]">Our Mission</h4>
                <p className="text-sm md:text-base lg:text-xl text-[#D7D9DD] max-w-[568px] font-light mt-3">Our Mission is
                    to
                    establish a
                    new standard of
                    excellence in
            ...
            <div className="max-w-[1364px] px-8 max-sm:pb-[111px] py-[60px] mx-auto">
                <div className="flex justify-between gap-10 max-[950px]:flex-wrap">
                    <div className="max-w-[309px]">
                        <label className="text-[#D7D9DD] text-base sm:text-lg md:text-xl lg:text-2xl mb-6 roboto-mono"
                        ...
                        <div className="flex flex-col gap-[10px] md:gap-[30px]">
                            ...
                            <div className="flex flex-col gap-[7px]">
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/Animal-health-check.html"}>Preventive Care</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/Skin.html"}>Sick Patient Care</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/Surgery.html"}>Surgery</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/Animal-health-check.html"}>Additional Services</Link>
                            </div>
                        </div>
                        <div className="flex flex-col gap-[10px] md:gap-[30px]">
                            <p className="Roboto-font text-[#D7D9DD] text-base sm:text-lg md:text-xl lg:text-2xl">
                            ...
                            <div className="flex flex-col gap-[7px]">
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/About.html"}>About us</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href={"/Join.html"}>Carreers</Link>
                            </div>
                        </div>
