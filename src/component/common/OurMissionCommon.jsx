...
function OurMissionCommon({abimg,title,para,bookbtn}) {
  return (
    <>
      <div className="bg-[#494336] pt-[60px] lg:pt-[80px] pb-[222px] sm:pb-[150px] lg:pb-[100px] xl:pb-[80px] relative">
            ...
            <div className="max-w-[1440px] mx-auto px-[32px] sm:px-[35px] md:px-[40px] lg:px-[180px] ">
                <h4 className="text-[24px] md:text-[30px] lg:text-[48px]  font-light text-[#D7D9DD]"> {title}</h4>
                <p className="text-sm md:text-base lg:text-xl text-[#D7D9DD] max-w-[568px] font-light mt-3">{para}</p>
