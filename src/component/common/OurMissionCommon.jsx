...
function OurMissionCommon({ abimg, title, para, bookbtn, h4Class }) {
  return (
    <>
      <div className="bg-[#494336] pt-[60px] lg:pt-[80px] pb-[180px] sm:pb-[130px] lg:pb-[100px] xl:pb-[80px] relative">
        ...
        <div className="max-w-[1440px] mx-auto px-[32px] sm:px-[35px] md:px-[40px] lg:px-[180px] ">
          <h4
            className={`text-[24px] md:text-[30px] lg:text-[36px]  font-light text-[#D7D9DD leading-[25px] ${h4Class}`}
          >
            {" "}
            {title}
          </h4>
