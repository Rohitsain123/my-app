import H5heading from "../common/H5heading";
import {
  FacebookIcon,
  InstaIcon,
  LinkedinIcon,
...
export const liData = [
  ...
  {
    lipara: " Toxin ingestion or foreign body",
  },
  {
    lipara: "Signs of pain",
  },
  {
    lipara: "Behavioral changes",
  },
  {
    lipara: " Eye issues",
  },
  {
    lipara: "Ear infections",
  },
  {
    lipara: "Vomiting or diarrhea",
  },
  {
    lipara: "Hair loss",
  },
  {
    lipara: "Coughing, sneezing or nasal discharge",
  },
  {
    lipara: "Urinating blood or urinary changes",
  },
  {
    lipara: "Worms, fleas, ticks or mites",
  },
  {
    lipara: "Scooting",
  },
  {
    lipara: "Changes in eating or drinking",
  },
];
...
export const visionData = [
  {
    ...
    title2: "Elevating the Standard of Care",
...
export const edgeData = [
  {
    ...
    title2: "Compassionate Care & Client Relationships",
...
export const downtownData = [
  {
    title: "Downtown",
    title2: "Opening Hours",
    title3: "Contact",
    para: "2468 18th Street, SWWashington DC, 20003",
    para2: "Monday - Friday: 8AM - 6PMSaturday: 9AM - 5PM",
    para3: "Sunday: Closed",
    para4: "Phone: (212) 123-4567",
    para5: "hello@nebulavets.com",
  },
];
...
export const leftData = [
  {
    img: "/assetes/img/png/map.png",
    title: "Preventive Care",
    subheading: "Your pet's well-being at the forefront of our practice.",
    para: "At Nebula Vets, we take a proactive approach to your pet's healthcare, prioritizing their well-being and aiming to maximize their quality of life. We believe in the importance of preventive medicine and early detection of potential health issues. By implementing regular wellness check-ups and comprehensive screenings, we can identify and address any problems at their earliest stages.",
    bookbtn: "BOOK NOW",
    subdata: [
      {
        title: "Animal Health Check",
        para: "Our practice offers the convenience of same or next-day appointments to ensure your furry companion receives prompt diagnostic evaluation and treatment. Our dedicated team prioritizes swift action, allowing us to quickly identify the issue at hand and provide the necessary care your pet requires.",
        learnbtn: "LEARN MORE",
        path: "/location",
      },
      {
        title: "Vaccinations",
        para: "Vaccinations are a key component of your pet’s health and essential to prevent life-threatening diseases. Nebula vets offer's all the core and non-core vaccines your pet might need.",
        learnbtn: "LEARN MORE",
        path: "/location",
      },
      {
        title: "Dentals",
        para: "Dental disease and smelly breath is common, and regular cleanings and exams can save your pet a lot of pain and disease later in life. Our advanced state-of-the-art dental suite is equipped for dental cleanings (scale and polish), extractions and any other care your pet may need.",
        learnbtn: "LEARN MORE",
        path: "/location",
      },
    ],
...
export const leftskinData = [
  {
    img: "/assetes/img/png/bandage.png",
    title: "Sick Patient Care",
    subheading:
      "Delivering exceptional care for sick patients, combining the virtues of efficiency and expertise ",
    para: "At Nebula Vets, we are fully equipped with advanced diagnostic tools and a wide range of treatment options to address any health issue your pet may be facing. Our commitment to comprehensive care means that we have the expertise and resources to provide accurate diagnoses and effective treatments.",
    bookbtn: "BOOK NOW",
    subdata: [
      {
        title: "Urgent & Emergency Care",
        para: "Whether your pet is sick or injured, we’re here to help get them the help they need. This includes telemedicine veterinary consults if you are unsure, and overnight care for 24-hour treatment.",
        learnbtn: "LEARN MORE",
      },
      {
...
export const leftsurgeryData = [
  {
    img: "/assetes/img/png/surgery-icon2.png",
    title: "Surgery",
    subheading:
      "Highly experienced surgeons -dedicated to delivering outstanding care for your pet.",
    para: "At Nebula Vets, we are equipped to handle a wide range of veterinary services, from emergency surgeries to routine procedures like neuters. Our team of skilled veterinarians is committed to providing the highest level of care to your pets.",
    bookbtn: "BOOK NOW",
    subdata: [
      {
        title: "Surgery",
        para: "In our advanced state-of-the-art surgery suite, our experienced doctors can perform all routine surgeries, including spays, neuters, basic soft tissue surgery, such as mass removals, laceration repair, abscesses, and dental procedures. All estimates are provided within 24 hours of receiving a request!",
        learnbtn: "LEARN MORE",
      },
      {
        title: "Spays & Neuters",
        para: "Our team comprises highly trained doctors who excel in routine surgery and harness the full potential of our state-of-the-art technology and advanced equipment. With their expertise and proficiency, they ensure optimal surgical outcomes for your beloved pets",
        learnbtn: "LEARN MORE",
      },
    ],
  },
];
export const additinoalservicesData = [
  {
    img: "/assetes/img/png/book.png",
    title: "Additional Services",
    subheading:
      "Additional Services that Go Above and Beyond: Experience Exceptional Veterinary Care at Nebula Vets",
    para: "Experience comprehensive veterinary care at Nebula Vets. We offer specialized services in travel document assistance, skin dermatology, microchipping, and compassionate euthanasia. Trust our experienced team for exceptional care tailored to your pet's unique needs.",
    bookbtn: "BOOK NOW",
    subdata: [
      {
        title: "Travel Certificates",
        para: "From domestic or international travel, you will usually require a health certificate for your pet. We can help with the necessary paperwork to allow your pet to join you on your travels –the process is simple and easy.",
        learnbtn: "LEARN MORE",
      },
      {
        title: "Skin & Dermatology",
        para: "If your pet is experiencing uncomfortable symptoms such as itchy skin, hair loss, or rashes, it may be indicative of allergies or infections. Our team of highly trained veterinarians specializes in diagnosing and treating various skin issues that can cause distress to your beloved companion. With their expertise and comprehensive understanding of dermatological conditions, they will diligently assess your pet's symptoms and develop a tailored treatment plan to address the underlying cause of their discomfort.",
        learnbtn: "LEARN MORE",
      },
      {
        title: "Microchipping",
        para: "A microchip, resembling a tiny grain of rice in size and shape, is delicately inserted beneath your pet's skin, specifically between the shoulder blades. This quick and completely safe procedure typically takes only a few minutes. ",
        learnbtn: "LEARN MORE",
      },
      {
        title: "Travel Certificates",
      ...
      {
        title: "Laser Therapy",
        para: "Our state-of-the-art veterinary hospital utilizes advanced laser technology to provide non-invasive and drug-free treatment options that promote healing and enhance the well-being of your beloved pets.",
        learnbtn: "LEARN MORE",
      },
      {
...
export const spayData = [
  {
    ...
    subdata: [
      {
        para: "Spaying and neutering has many health and behavioral benefits for your cat or dog. Spaying at a young age has been shown to reduce the occurrence of mammary cancers and uterine infections (also known as pyometra). It also removes heat cycles and coming into season.",
      },
      {
        para: "Neutering has been proven to prevent testicular cancer and may prevent different forms of prostate diseases, and both spaying and neutering may also help prevent or alter unwanted behaviors, such as aggressive behavior and urine marking.",
      },
      {
        para: "When to spay or neuter.",
      },
      {
        title: "When to spay or neuter?",
        para: "Dog spays and neuters are performed between the ages of 6 and 9 months of age. Large breed dogs, it is advised to wait until they’re a little older to take full advantage of their growth hormones and allow their bones to mature.",
        para2:
      ...
      },
      {
        ...
        para: "Spaying or neutering your pet can save you money in the long run. The cost of the procedure is typically less than the expenses associated with caring for a litter or treating health conditions that may arise from not being spayed or neutered.",
      },
    ],
  },
];
export const travelData = [
  {
    ...
    para: "At Nebula Vets, we understand that your pet is an important part of your family, and we want to make sure they can accompany you on your domestic or international travels. We offer assistance in obtaining the necessary health certificates and paperwork required for your pet's travel.",
    subdata: [
      {
        title: "Documentation Assistance",
        para: "Gathering the required documentation for travel can be overwhelming and confusing. Our team will provide detailed instructions on the documentation needed and guide you through the process. We will assist you in completing the paperwork accurately, including filling out any forms and providing relevant information to ensure a smooth and hassle-free travel experience for you and your pet.",
      },
      {
        title: "Domestic Travel",
        para: "Regulations for pet travel vary between states, and how you’re getting there. Each airline has different requirements and specific forms for you to fill out about your pet. Our vets can advise on what exactly you need.",
      },
      {
    ...
    subdata: [
      {
        ...
        para: "Pets can sometimes wander or accidentally get lost, causing distress to both the pet and their owners. A microchip provides a permanent form of identification that cannot be lost or removed. If your pet goes missing and is found by a shelter or veterinary clinic, they can scan the microchip to retrieve your contact information and swiftly reunite you with your beloved pet.",
      },
      {
        title: "Increased Chance of Recovery",
        para: "Studies have shown that pets with microchips have a significantly higher chance of being reunited with their owners compared to those without. By having your pet microchipped, you enhance the chances of a successful reunion, saving precious time, and reducing the emotional strain of a lost pet situation.",
      },
      {
        title: "Secure and Permanent",
        para: "Unlike collars or tags, which can break or be removed, a microchip is a tiny, implantable device that is safely and painlessly inserted under your pet's skin. Once in place, it remains with your pet for life, ensuring a permanent form of identification that cannot be tampered with or lost.",
      },
      {
        title: "Universal Recognition",
        para: "Microchips are recognized and read by most veterinary clinics, animal shelters, and animal control agencies worldwide. This means that if your pet gets lost during travel or relocation, their microchip can be scanned and their identification information accessed regardless of where they are found.",
      },
      {
        title: "Medical Information Access",
        para: "Advanced microchips can store additional medical information about your pet, such as vaccinations, allergies, or any ongoing medical conditions. This feature can be especially helpful in emergency situations when immediate access to crucial health details can make a significant difference in the treatment and care your pet receives.",
      },
    ],
  },
];
